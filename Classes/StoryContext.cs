...
namespace uchot.Classes
{
    ...
    {
        public StoryContext(int Id, int Id_pc, int Code_Old, int Code_New, DateTime Data, int User_Old, int User_New, string Comment) : base(Id, Id_pc, Code_Old, Code_New, Data, User_Old, User_New, Comment) { }
